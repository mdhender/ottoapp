...
type User_t struct {
	...
	// full path to user data. the input, logs, and output folders are children of this folder
	Data string
...
var (
	...
	ErrInvalidTurnMonth     = errors.New("invalid turn month")
	ErrInvalidTurnYear      = errors.New("invalid turn year")
